    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        if (isset($_POST["submit"])) {
          ...
          {
            $query = "INSERT INTO news (userid,danhmucid,tieude,tomtat,noidung,ngaydang,image_jpg) 
                     VALUES ('$userid','$danhmucid','$title','$tomtat','$noidung','$date','$img')";
          ...
          {
            $query = "INSERT INTO news (userid,danhmucid,tieude,tomtat,noidung,ngaydang) 
                     VALUES ('$userid','$danhmucid','$title','$tomtat','$noidung','$date')";
            mysqli_set_charset($conn, "UTF8");
            mysqli_query($conn, $query);
            echo '';
          }
