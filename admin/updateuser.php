          ...
          if (isset($_POST["submit"])) {
            ...
            if (!empty($_FILES['avatar']['name'])) {
              $query = "UPDATE users
                      ...
                      phone = '$phone', address = '$address', user_level = '$level', 	registration_date = '$date', avatar='$img'
                      WHERE userid = '$postId'";
              ...
              $query = "UPDATE users
                      SET email = '$email', first_name = '$first_name', last_name = '$last_name', 
                      phone = '$phone', address = '$address', user_level = '$level', 	registration_date = '$date'
                      WHERE userid = '$postId'";
              mysqli_set_charset($conn, "UTF8");
              mysqli_query($conn, $query);
                  ...
                  <div class="col-md-8">
                    ...
                    <div class="row">
                      <div class="update ml-auto mr-auto">
                        <button type="submit" name="submit" class="btn btn-primary btn-round">OK</button>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <img id="avatar" class="thumbnail" width="100%" height="100%" src="uploads/avatar/<?php echo $row['avatar'] ?>">
                    </div>
                  </div>
                </div>
              </form>
